...
# install badvpn
cd
wget -O /usr/sbin/badvpn "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/badvpn3.service" >/dev/null 2>&1
...
# // install lolcat
wget https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
...
wget -O add-ssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/add-ssws.sh"
wget -O cek-ssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/cek-ssws.sh"
