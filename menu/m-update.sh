...
wget -O /usr/bin/renew-tr "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-tr.sh" && chmod +x /usr/bin/renew-tr
...
wget -O /usr/bin/del-vless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-vless.sh" && chmod +x /usr/bin/del-vless
