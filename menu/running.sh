...
echo -e "$COLOR1┌───────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 $NC  ${WH}❇️ Hostname    ${COLOR1}: ${WH} $HOSTNAME"
echo -e "$COLOR1 $NC  ${WH}❇️ OS Name     ${COLOR1}: ${WH} $Tipe"
echo -e "$COLOR1 $NC  ${WH}❇️ Total RAM   ${COLOR1}: ${WH} ${totalram}MB"
echo -e "$COLOR1 $NC  ${WH}❇️ Public IP   ${COLOR1}: ${WH} $MYIP"
echo -e "$COLOR1 $NC  ${WH}❇️ Domain      ${COLOR1}: ${WH} $Domen"
echo -e "$COLOR1└───────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "$COLOR1┌───────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                ${WH}⇱ SUBSCRIPTION INFORMATION ⇲          \E[0m"
echo -e "$COLOR1└───────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "$COLOR1┌───────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 $NC  ${WH}❇️ Client Name ${COLOR1}: ${WH} $Name"
echo -e "$COLOR1 $NC  ${WH}❇️ Expired     ${COLOR1}: ${WH} $Exp2"
echo -e "$COLOR1 $NC  ${WH}❇️ Version     ${COLOR1}: ${WH} Latest Version"
echo -e "$COLOR1└───────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "$COLOR1┌───────────────────────────────────────────────────┐${NC}"
...
echo -e " $COLOR1 $NC                                              ${NC} $COLOR1 $NC"
echo -e "$COLOR1┌───────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 $NC  ${WH}❇️ SSH / TUN               ${COLOR1}: ${WH}$status_ssh"
echo -e "$COLOR1 $NC  ${WH}❇️ OpenVPN                 ${COLOR1}: ${WH}$status_openvpn"
echo -e "$COLOR1 $NC  ${WH}❇️ Dropbear                ${COLOR1}: ${WH}$status_beruangjatuh"
echo -e "$COLOR1 $NC  ${WH}❇️ Stunnel4                ${COLOR1}: ${WH}$status_stunnel"
#echo -e "❇️ Squid                   :$status_squid"
echo -e "$COLOR1 $NC  ${WH}❇️ Fail2Ban                ${COLOR1}: ${WH}$status_fail2ban"
echo -e "$COLOR1 $NC  ${WH}❇️ Crons                   ${COLOR1}: ${WH}$status_cron"
echo -e "$COLOR1 $NC  ${WH}❇️ Vnstat                  ${COLOR1}: ${WH}$status_vnstat"
echo -e "$COLOR1 $NC  ${WH}❇️ XRAYS Vmess TLS         ${COLOR1}: ${WH}$status_tls_v2ray"
echo -e "$COLOR1 $NC  ${WH}❇️ XRAYS Vmess None TLS    ${COLOR1}: ${WH}$status_nontls_v2ray"
echo -e "$COLOR1 $NC  ${WH}❇️ XRAYS Vless TLS         ${COLOR1}: ${WH}$status_tls_vless"
echo -e "$COLOR1 $NC  ${WH}❇️ XRAYS Vless None TLS    ${COLOR1}: ${WH}$status_nontls_vless"
echo -e "$COLOR1 $NC  ${WH}❇️ XRAYS Trojan            ${COLOR1}: ${WH}$status_virus_trojan"
echo -e "$COLOR1 $NC  ${WH}❇️ Shadowsocks             ${COLOR1}: ${WH}$status_shadowsocks"
echo -e "$COLOR1 $NC  ${WH}❇️ Websocket TLS           ${COLOR1}: ${WH}$swstls"
echo -e "$COLOR1 $NC  ${WH}❇️ Websocket None TLS      ${COLOR1}: ${WH}$swstls"
echo -e "$COLOR1 $NC  ${WH}❇️ OHP Dropbear            ${COLOR1}: ${WH}$sohp"
echo -e "$COLOR1 $NC  ${WH}❇️ OHP OpenVPN             ${COLOR1}: ${WH}$sohq"
echo -e "$COLOR1 $NC  ${WH}❇️ OHP SSH                 ${COLOR1}: ${WH}$sohr"
