...
wget -q -O /usr/bin/m-backup "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/menu/m-backup.sh" && chmod +x /usr/bin/m-backup
...
wget -q -O /usr/bin/add-host "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/add-host.sh" && chmod +x /usr/bin/add-host
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/usernew.sh" && chmod +x /usr/bin/usernew
wget -q -O /usr/bin/trial "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/trial.sh" && chmod +x /usr/bin/trial
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/tendang.sh" && chmod +x /usr/bin/tendang
wget -q -O /usr/bin/member "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/member.sh" && chmod +x /usr/bin/member
wget -q -O /usr/bin/hapus "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/hapus.sh" && chmod +x /usr/bin/hapus
wget -q -O /usr/bin/cek "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/cek.sh" && chmod +x /usr/bin/cek
wget -q -O /usr/bin/autokill "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/autokill.sh" && chmod +x /usr/bin/autokill
wget -q -O /usr/bin/ceklim "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/ssh/ceklim.sh" && chmod +x /usr/bin/ceklim
...
wget -q -O /usr/bin/trialvmess "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/trialvmess.sh" && chmod +x /usr/bin/trialvmess
wget -q -O /usr/bin/trialvless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/trialvless.sh" && chmod +x /usr/bin/trialvless
wget -q -O /usr/bin/trialtrojan "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/trialtrojan.sh" && chmod +x /usr/bin/trialtrojan
wget -q -O /usr/bin/trialssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/trialssws.sh" && chmod +x /usr/bin/trialssws
wget -q -O /usr/bin/renew-vmess "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-vmess.sh" && chmod +x /usr/bin/renew-vmess
wget -q -O /usr/bin/renew-vless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-vless.sh" && chmod +x /usr/bin/renew-vless
wget -q -O /usr/bin/renew-tr "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-tr.sh" && chmod +x /usr/bin/renew-tr
wget -q -O /usr/bin/renew-ssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-ssws.sh" && chmod +x /usr/bin/renew-ssws
wget -q -O /usr/bin/del-vmess "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-vmess.sh" && chmod +x /usr/bin/del-vmess
wget -q -O /usr/bin/del-vless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-vless.sh" && chmod +x /usr/bin/del-vless
wget -q -O /usr/bin/del-tr "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-tr.sh" && chmod +x /usr/bin/del-tr
wget -q -O /usr/bin/del-ssws "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-ssws.sh" && chmod +x /usr/bin/del-ssws
wget -q -O /usr/bin/cek-vmess "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/cek-vmess.sh" && chmod +x /usr/bin/cek-vmess
wget -q -O /usr/bin/cek-vless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/cek-vless.sh" && chmod +x /usr/bin/cek-vless
