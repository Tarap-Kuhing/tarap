...
wget -q -O /usr/bin/m-update "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/menu/m-update.sh" && chmod +x /usr/bin/m-update
...
wget -q -O /usr/bin/renew-tr "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/renew-tr.sh" && chmod +x /usr/binrenew-tr
...
wget -q -O /usr/bin/del-vless "https://raw.githubusercontent.com/Tarap-Kuhing/tarap/main/xray/del-vless.sh" && chmod +x /usr/bindel-vless
